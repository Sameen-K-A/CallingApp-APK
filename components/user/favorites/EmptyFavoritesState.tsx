  ...
  return (
    <View className="flex-1 items-center justify-center px-8 py-16">
      <View className="relative mb-8">
        <View className="w-40 h-40 rounded-full bg-destructive/5 items-center justify-center">
          <View className="w-28 h-28 rounded-full bg-destructive/10 items-center justify-center">
        ...
        <View className="absolute -bottom-1 -left-3 w-6 h-6 rounded-full bg-success/20 items-center justify-center">
          <View className="w-2 h-2 rounded-full bg-success" />
        </View>
        <View className="absolute top-1/2 -right-4 w-5 h-5 rounded-full bg-warning/20 items-center justify-center">
      ...
      >
        Start adding telecallers you love to see them here. Your favorites will be just a tap away!
      </Text>
